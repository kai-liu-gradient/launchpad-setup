...
MSG_DEPLOY_PROGRESS_K3S="K3s installation"
MSG_DEPLOY_PROGRESS_SSL="SSL certificates"
MSG_DEPLOY_PROGRESS_INGRESS="Ingress-Nginx ready"
MSG_DEPLOY_PROGRESS_COREDNS="CoreDNS configured"
MSG_DEPLOY_PROGRESS_KYVERNO="Kyverno installed"
MSG_DEPLOY_PROGRESS_CERTDIST="CA cert distributed"
