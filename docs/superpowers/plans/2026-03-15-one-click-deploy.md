...
**Core (static):** `NODE_ENV=production`, `PORT=6802`, `ADMIN_PORT=6804`, `USE_REDIS=true`, `MULTI_INSTANCE=true`, `KUBERNETES_ENABLED=true`, `ANI_CODE_GATEWAY_ENABLED=true`
**Storage:** `STORAGE_PROVIDER=${STORAGE_PROVIDER}`, `AZURE_CONTAINER_SAS_URL=${AZURE_CONTAINER_SAS_URL}`, `S3_ENDPOINT`, `S3_BUCKET`, `S3_ACCESS_KEY`, `S3_SECRET_KEY`
